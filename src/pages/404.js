...
export default function Custom404() {
  // Add hydration code to ensure proper styling
  useEffect(() => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-950 p-4">
      <div className="text-center max-w-md mx-auto p-8 bg-white dark:bg-gray-900 rounded-xl shadow-lg">
        ...
        <Link 
          href="/"
          className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 transition-colors text-white rounded-lg font-medium inline-block"
        >
          Return Home
        </Link>
      </div>
